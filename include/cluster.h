...
#include <pcl/common/impl/common.hpp> // polygon area calculation
...
class Cluster
{
    ...
    pcl::PointXYZI min_point_;  ///< min_point_ 
     ...
     * @param[in] nmea_msg_header     nmea obstacle msg sensor type, i.e. PYROB, PYLOB
     * 
     * 
     */
